<%-- 
    ...
    Created on : Jun 14, 2024, 2:33:02 PM
    Author     : chucken
--%>
...
<!--aria hidden dùng để hiển ẩn khỏi màn hình 
    role dialog : 1 loại thẻ sẽ pop up ra màn hình vẫn giữ nguyên đc trạng thái phía 
    aria label: close:  dùng để ẩn đi cái pop up hiện ra-->
