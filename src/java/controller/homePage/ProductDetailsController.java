...
public class ProductDetailsController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //set product vao request sau do chuyen sang product-details.jsp
        request.setAttribute("productFoundById", productFoundById);
        request.getRequestDispatcher("views/homePage/product-details.jsp").forward(request, response);
